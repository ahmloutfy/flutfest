  ...
  Widget build(BuildContext context) {
    return ElevatedButton.icon(
      ...
      onPressed: () {
        ...
        final isNowFavorite =
            favoriteController.toggleFavorite(widget.event.id);
        showCustomSnackBar(
      ...
      icon: GetBuilder<FavoriteController>(
        ...
        builder: (favController) {
          return Icon(
            color: favController.favoriteEvents.containsKey(widget.event.id) &&
                    favController.favoriteEvents[widget.event.id]!
                ? Colors.red
                : Colors.grey,
